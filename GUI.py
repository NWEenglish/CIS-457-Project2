...
searchResult = ttk.Treeview(gui, columns=("hostname", "filename"), height = 5)
searchResult.column("#0", width = 120, minwidth = 120, stretch = tkinter.NO)
searchResult.heading("#0", text="Speed", anchor=tkinter.W)
searchResult.column("hostname", width = 260, minwidth = 260, stretch = tkinter.NO)
searchResult.heading("hostname", text="Hostname", anchor=tkinter.W)
searchResult.column("filename", width = 250, minwidth = 250, stretch = tkinter.NO)
